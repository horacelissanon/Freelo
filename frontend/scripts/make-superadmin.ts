...
// imported by tests. Uses pathToFileURL rather than a manual `file://`
// template: on Windows process.argv[1] is backslash-separated and drive-
// letter-prefixed (e.g. "C:\...\script.ts"), which never matches
// import.meta.url's forward-slash "file:///C:/..." form — that mismatch
// silently made this guard false (and the whole script a no-op) on Windows.
