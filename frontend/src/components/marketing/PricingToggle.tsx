...
// cards. Real ZeFacto figures only (Toggle component + math below, nothing
...
const FALLBACK_FREE_FEATURES = [
  ...
  'Badge « Créé avec ZeFacto » sur ton lien de suivi',
];
const FALLBACK_PRO_FEATURES = [
  ...
  'Sans badge « Créé avec ZeFacto » sur ton lien de suivi',
];
...
// philosophy as the app's other optional providers. ZeFacto's own Pro
