...
export function InvoiceCard({
  ...
  // pure red) — applied to the whole card so an overdue facture or expired
  // devis stands out in the grid, not just its small status chip.
