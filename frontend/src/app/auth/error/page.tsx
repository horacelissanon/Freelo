...
function AuthErrorBody() {
  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-md flex-col justify-center gap-6 bg-background px-4">
      ...
      {code && <p className="font-mono text-xs text-muted-foreground/70">code: {code}</p>}
      <div className="flex flex-col gap-2">
        <Link
          href="/login"
          className="rounded-md bg-primary px-5 py-2.5 text-center font-body text-sm font-medium text-primary-foreground"
        >
