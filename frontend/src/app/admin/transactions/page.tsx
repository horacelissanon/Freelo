  ...
  return (
    <div>
      <header className="mb-6">
        <h1 className="font-headings text-2xl font-bold text-foreground">Facturation</h1>
          ...
          <div className={`p-5 ${cardClass}`}>
            {items.map((tx) => (
              ...
              >
                ...
                <span className="flex-shrink-0 rounded-full bg-muted px-2.5 py-1 text-xs font-medium text-foreground">
